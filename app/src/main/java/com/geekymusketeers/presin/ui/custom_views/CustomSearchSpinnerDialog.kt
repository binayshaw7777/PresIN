...
import com.geekymusketeers.presin.adapter.CustomSpinnerAdapter
import com.geekymusketeers.presin.databinding.LayoutCustomSearchSpinnerDialogBinding
import com.geekymusketeers.presin.utils.getBaseStringForFiltering
        ...
        override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
            if (s.isNullOrEmpty()) {
                ...
                for (item in itemList) {
                    if ((item.lowercase().getBaseStringForFiltering()).contains(s.toString().lowercase().getBaseStringForFiltering())) {
                        filterList.add(item)
                    }
                }
